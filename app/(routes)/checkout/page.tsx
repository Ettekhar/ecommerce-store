...
const Checkout = () => {
    ...
    const checkWhatsAppNumber = async (phoneNumber) => {
        try {
            // Replace with your own API call to check WhatsApp status
            const response = await axios.get(`/api/check-whatsapp?phone=${phoneNumber}`);
    ...
    const onSubmit = async (data) => {
        ...
        setLoading(true);
        console.log({data});
        // const hasWhatsApp = await checkWhatsAppNumber(data.phone);
